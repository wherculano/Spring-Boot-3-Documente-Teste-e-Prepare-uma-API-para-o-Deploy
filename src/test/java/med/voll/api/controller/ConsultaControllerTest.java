...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Deve devolver código 400 quando as informações estiverem invalidas.")
    @WithMockUser
    ...
    @Test
    @DisplayName("Deve devolver código 200 quando as informações estiverem validas.")
    @WithMockUser
